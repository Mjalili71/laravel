...
<body>
    ...
    <form action="{{route('admin.content.post.store')}}" method="post" enctype="multipart/form-data"  name="jj"id="form">
       ...
       <div>
                ...
                <textarea name="summary" id="summary"   rows="6">{{ old('summary') }}</textarea>
            </div>                 
            @error('summary')
            <span class="alert_required bg-black text-white p-1 rounded" role="alert">
                <strong>
        ...
        <section >
            ...
            <button class="btn btn-primary btn-sm">ایجاد پست</button>
